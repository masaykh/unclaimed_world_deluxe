	...
	technique StandardRenderMonochrome
	{
		pass Pass1
		{        
			VertexShader = compile vs_3_0 /*vs_2_0*/ TransformVertex(); // #MONOCHANGE was: vs_4_0_level_9_1
			PixelShader = compile ps_3_0 /*ps_2_0*/ TransformPixelTrueTrueFalse(); // TransformPixel(true, true, false);
		}
	}
    ...
    technique SkinnedRender
    {
        pass P0
        {
			...
			PixelShader = compile ps_3_0 TransformPixelTrueFalseFalse();
        }
    }
	/*technique SkinnedRender
	{
		pass P0
		{
			VertexShader = compile vs_3_0 TransformVertexDebug();
			PixelShader = compile ps_3_0 TransformPixelDebug();
		}
	}*/
    ...
    technique SkinnedRenderNoLighting
    {
        pass P0
        {
			VertexShader = compile vs_3_0 /*vs_2_0*/ TransformVertex();
			PixelShader = compile ps_3_0 /*ps_2_0*/ TransformPixelFalseFalseFalse(); // TransformPixel(false, false, false);
        }
    }
	...
	technique StandardOverlay
	{
		pass P0
		{        
			VertexShader = compile vs_3_0 /*vs_3_0*/ TransformVertex();
			PixelShader = compile ps_3_0 /*ps_3_0*/ TransformPixelTrueFalseTrue(); // TransformPixel(true, false, true);
		}
	}
    ...
    technique DepthHeightBillboardAlpha
    {
        ...
        {
			VertexShader = compile vs_3_0 /*vs_2_0*/ TransformVertex();
			PixelShader = compile ps_3_0 /*ps_2_0*/ PS_DepthHeightBillboardAlpha();
        }
    }
	...
	technique EmittersOnly
	{
        ...
        {
			VertexShader = compile vs_3_0 /*vs_2_0*/ TransformVertex();
			PixelShader = compile ps_3_0 /*ps_2_0*/ RenderEmitters();
        }
	}
	...
	technique NormalDepth
	{
		pass P0
		{
			...
			VertexShader = compile vs_3_0 /*vs_2_0*/ NormalDepthVertexShader();
			PixelShader = compile ps_3_0 /*ps_2_0*/ NormalDepthPixelShader();
