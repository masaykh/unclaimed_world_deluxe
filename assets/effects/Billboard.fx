...
technique Standard
{
    pass RenderAll
    {
		...
		PixelShader = compile ps_3_0 PixelShaderFunctionTrueFalse(); // PixelShaderFunction(true, false);
    }   
}
...
technique Outline
{
    pass RenderAll
    {
		VertexShader = compile vs_3_0 VertexShaderOutlineFunction();
		PixelShader = compile ps_3_0 PixelShaderOutlineFunction();
    }   
}
...
technique StandardDebugLighting
{
    ...
    {
		VertexShader = compile vs_3_0 VertexShaderFunction();
		PixelShader = compile ps_3_0 PixelShaderFunctionTrueTrue(); // PixelShaderFunction(true, true);
...
technique StandardAtNight
{
    ...
    {
		VertexShader = compile vs_3_0 VertexShaderFunction();
		PixelShader = compile ps_3_0 PixelShaderFunctionFalseFalse(); // PixelShaderFunction(false, false);
...
technique NormalsAndDepthMap
{
    ...
    {
		VertexShader = compile vs_3_0 VertexShaderFunction();
		PixelShader = compile ps_3_0 PixelShaderRenderToNormalsAndDepthMap();
