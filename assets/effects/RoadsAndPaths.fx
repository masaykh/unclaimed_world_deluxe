...
technique RenderGroundSprites
{
    pass Pass1
    {        
		VertexShader = compile vs_3_0 /*vs_1_1*/ VertexShaderFunction();
		PixelShader = compile ps_3_0 PixelShaderFunctionFalse(); // PixelShaderFunction(false);
    }
}
...
technique RenderOutlineGroundSprites
{
    ...
    {        
		VertexShader = compile vs_3_0 /*vs_1_1*/ VertexShaderFunction();
		PixelShader = compile ps_3_0 /*ps_2_0*/ PixelShaderOutlineFunction();
    }
}
...
technique RenderGroundSpritesDebugLighting
{
    ...
    {        
		VertexShader = compile vs_3_0 /*vs_1_1*/ VertexShaderFunction();
		PixelShader = compile ps_3_0 /*ps_2_0*/ PixelShaderFunctionTrue(); // PixelShaderFunction(true);
    }
}