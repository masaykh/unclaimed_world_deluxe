...
technique RenderRocksSingleLayer0
{
    pass Pass0
    {
		...
		PixelShader = compile ps_3_0 RenderRocksPS0False(); // RenderRocksPS(0.0f, false);
    }
}
...
technique RenderRocksSingleLayer1
{
    ...
    {
		VertexShader = compile vs_3_0 MultiTexturedVS();
		PixelShader = compile ps_3_0 RenderRocksPS1False(); // RenderRocksPS(1.0f, false);
    }
}
...
technique RenderRocksSingleLayer2
{
    ...
    {
		VertexShader = compile vs_3_0 MultiTexturedVS();
		PixelShader = compile ps_3_0 RenderRocksPS2False(); // RenderRocksPS(2.0f, false);
    }
}
...
technique DebugRenderRocksSingleLayer0
{
    ...
    {
		VertexShader = compile vs_3_0 MultiTexturedVS();
		PixelShader = compile ps_3_0 RenderRocksPS0True(); // RenderRocksPS(0.0f, true);
    }
}
...
technique DebugRenderRocksSingleLayer1
{
    ...
    {
		VertexShader = compile vs_3_0 MultiTexturedVS();
		PixelShader = compile ps_3_0 RenderRocksPS1True(); // RenderRocksPS(1.0f, true);
    }
}
...
technique DebugRenderRocksSingleLayer2
{
    ...
    {
		VertexShader = compile vs_3_0 MultiTexturedVS();
		PixelShader = compile ps_3_0 RenderRocksPS2True(); // RenderRocksPS(2.0f, true);
    }
}
...
technique MultiTextured0
{
    ...
    {
		VertexShader = compile vs_3_0 MultiTexturedVS();
		PixelShader = compile ps_3_0 MultiTexturedPS0(); // MultiTexturedPS(0.0f, -1.0f);
    }
}
...
technique MultiTextured1
{
    ...
    {
		VertexShader = compile vs_3_0 MultiTexturedVS();
		PixelShader = compile ps_3_0 MultiTexturedPS1(); // MultiTexturedPS(1.0f, -1.0f);
...
technique MultiTextured2
{
    ...
    {
		VertexShader = compile vs_3_0 MultiTexturedVS();
		PixelShader = compile ps_3_0 MultiTexturedPS2(); // MultiTexturedPS(2.0f, -1.0f);
    }
}
...
technique MultiTextured00
{
    ...
    {
		VertexShader = compile vs_3_0 MultiTexturedVS();
		PixelShader = compile ps_3_0 MultiTexturedPS00(); // MultiTexturedPS(0.0f, 0.0f);
    }
}
...
technique MultiTextured10
{
    ...
    {
		VertexShader = compile vs_3_0 MultiTexturedVS();
		PixelShader = compile ps_3_0 MultiTexturedPS10(); // MultiTexturedPS(1.0f, 0.0f);
...
technique MultiTextured20
{
    ...
    {
		VertexShader = compile vs_3_0 MultiTexturedVS();
		PixelShader = compile ps_3_0 MultiTexturedPS20(); // MultiTexturedPS(2.0f, 0.0f);
    }
}
...
technique MultiTextured01
{
    ...
    {
		VertexShader = compile vs_3_0 MultiTexturedVS();
		PixelShader = compile ps_3_0 MultiTexturedPS01(); // MultiTexturedPS(0.0f, 1.0f);
    }
}
...
technique MultiTextured11
{
    ...
    {
		VertexShader = compile vs_3_0 MultiTexturedVS();
		PixelShader = compile ps_3_0 MultiTexturedPS11(); // MultiTexturedPS(1.0f, 1.0f);
...
technique MultiTextured21
{
    ...
    {
		VertexShader = compile vs_3_0 MultiTexturedVS();
		PixelShader = compile ps_3_0 MultiTexturedPS21(); // MultiTexturedPS(2.0f, 1.0f);
    }
}
...
technique MultiTextured02
{
    ...
    {
		VertexShader = compile vs_3_0 MultiTexturedVS();
		PixelShader = compile ps_3_0 MultiTexturedPS02(); // MultiTexturedPS(0.0f, 2.0f);
    }
}
...
technique MultiTextured12
{
    ...
    {
		VertexShader = compile vs_3_0 MultiTexturedVS();
		PixelShader = compile ps_3_0 MultiTexturedPS12(); // MultiTexturedPS(1.0f, 2.0f);
...
technique MultiTextured22
{
    ...
    {
		VertexShader = compile vs_3_0 MultiTexturedVS();
		PixelShader = compile ps_3_0 MultiTexturedPS22(); // MultiTexturedPS(2.0f, 2.0f);
    }
}
