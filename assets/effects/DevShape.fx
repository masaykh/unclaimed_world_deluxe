...
technique LineRendering3D
{
	pass PassFor3D
	{
		VertexShader = compile vs_3_0 /*vs_1_1*/ LineRendering3DVS();
		PixelShader = compile ps_3_0 /*ps_2_0*/ LineRendering3DPS();
	}
}
...
technique LineRendering2D
{
	pass PassFor2D
	{
		VertexShader = compile vs_3_0 /*vs_1_1*/ LineRendering2DVS();
		PixelShader = compile ps_3_0 /*ps_2_0*/ LineRendering2DPS();
	}
}
