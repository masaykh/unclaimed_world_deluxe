...
technique StandardRenderMonochrome
{
    pass Pass1
    {        
		VertexShader = compile vs_3_0 /*vs_3_0*/ VertexShaderFunctionTrue(); // VertexShaderFunction(true);
		PixelShader = compile ps_3_0 /*ps_3_0*/ PixelShaderFunctionTrueTrueFalse(); // PixelShaderFunction(true, true, false);
    }
}
...
technique StandardRender
{
    ...
    {       
		...
		VertexShader = compile vs_3_0 /*vs_3_0*/ VertexShaderFunctionTrue(); // VertexShaderFunction(true);
		PixelShader = compile ps_3_0 /*ps_3_0*/ PixelShaderFunctionTrueFalseFalse(); // PixelShaderFunction(true, false, false);
    }
}
...
technique StandardRenderNoReflection
{
    pass Pass1
    {        
		VertexShader = compile vs_3_0 /*vs_3_0*/ VertexShaderFunctionFalse(); // VertexShaderFunction(false);
		PixelShader = compile ps_3_0 /*ps_3_0*/ PixelShaderFunctionTrueFalseFalse(); //PixelShaderFunction(true, false, false);
    }
}
...
technique StandardOverlay
{
    ...
    {        
		VertexShader = compile vs_3_0 /*vs_3_0*/ VertexShaderFunctionTrue(); // VertexShaderFunction(true);
		PixelShader = compile ps_3_0 /*ps_3_0*/ PixelShaderFunctionTrueFalseTrue(); // PixelShaderFunction(true, false, true);
    }
}
...
technique RenderNoLighting
{
    pass P0
    {
		VertexShader = compile vs_3_0 VertexShaderFunctionFalse(); //VertexShaderFunction(false);
		PixelShader = compile ps_3_0 PixelShaderFunctionFalseFalseFalse(); // PixelShaderFunction(false, false, false);
    }
}
...
technique DepthHeightBillboardAlpha
{
    ...
    {
		VertexShader = compile vs_3_0 VertexShaderFunctionFalse(); //VertexShaderFunction(false);
		PixelShader = compile ps_3_0 PS_DepthHeightBillboardAlpha();
    }
}
...
technique EmittersOnly
{
    ...
    {
		VertexShader = compile vs_3_0 VertexShaderFunctionFalse(); //VertexShaderFunction(false);
		PixelShader = compile ps_3_0 RenderEmitters();
    }
}
...
technique NormalDepth
{
	pass P0
	{
		...
		PixelShader = compile ps_3_0 NormalDepthPixelShader(); // #MONOCHANGE - higher shader model
	}
}