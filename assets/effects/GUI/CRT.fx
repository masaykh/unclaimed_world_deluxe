...
technique CRT
{
    pass Pass1
    {
		...
		PixelShader = compile ps_3_0 /*ps_2_0*/ PixelShaderFunctionHQFalse();
    }
}
...
technique CRT_HighQuality 
{
    pass Pass1
    {
		...
		VertexShader = compile vs_3_0 /*vs_3_0*/ VertexShaderFunction();
		PixelShader = compile ps_3_0 /*ps_3_0*/ PixelShaderFunctionHQTrue();
    }
}
