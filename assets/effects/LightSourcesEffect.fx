...
technique DrawLightSources
{
    ...
    {        
		...
		PixelShader = compile ps_3_0 /*ps_2_0*/ PixelShaderLightSources();
    }
}
...
technique DrawModelEmitterLights
{
    pass Pass1
    {        
		VertexShader = compile vs_3_0 /*vs_1_1*/ VertexShaderModelEmitterLights();
		PixelShader = compile ps_3_0 /*ps_2_0*/ PixelShaderModelEmitterLights();
    }
}