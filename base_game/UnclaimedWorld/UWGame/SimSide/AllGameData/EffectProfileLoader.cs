...
public class EffectProfileLoader
{
	public static List<EffectProfileType> Init()
	{
		...
		list.Add(new EffectProfileType
		{
			...
			Name = "Alcohol",
			Effects = new string[1] { "stimulantComfortEffect" },
			SortOrder = 10
		});
		list.Add(new EffectProfileType
		{
			...
			Name = "Alcohol",
			Effects = new string[1] { "highStimulantComfortEffect" },
			SortOrder = 20
		});
		list.Add(new EffectProfileType
		{
		...
		list.Add(new EffectProfileType
		{
			...
			Effects = new string[1] { "nightVision" },
			SortOrder = 50
		});
		list.Add(new EffectProfileType
		{
			...
			Effects = new string[1] { "groundScanner" },
			SortOrder = 60
		});
		list.Add(new EffectProfileType
		{
			KeyName = "leader",
			Name = "Leader",
			Description = "The leader will never leave the site",
			Effects = new string[2] { "leaderCannotEmigrate", "leaderCannotComplain" },
			SortOrder = 70
		});
		list.Add(new EffectProfileType
		{
			...
			Effects = new string[1] { "smallHomeComfortEffect" },
			SortOrder = 80
		});
		list.Add(new EffectProfileType
		{
			...
			Effects = new string[1] { "modestHomeComfortEffect" },
			SortOrder = 90
		});
		list.Add(new EffectProfileType
		{
		...
		list.Add(new EffectProfileType
		{
			...
			Effects = new string[1] { "openStoveComfortEffect" },
			SortOrder = 100
		});
		return list;
	}
