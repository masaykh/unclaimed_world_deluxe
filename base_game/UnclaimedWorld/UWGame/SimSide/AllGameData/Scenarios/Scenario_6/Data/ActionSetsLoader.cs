...
public class ActionSetsLoader
{
	public static List<ActionSets> Init()
	{
		...
		list.Add(new ActionSets
		{
			...
			{
				new ActionSetType("1df39063-8504-afds325456uyjip-ggsefs3-a65c34756a91")
				{
					MaxFirings = 1,
					Condition = new PlayerAllegiancePersons
					{
					...
					Actions = new EventActionType[2]
					{
						new TalkAction("de0c6aa-dd5dsdwasdwad-a098-e3c68a3150a3")
						{
						...
						new TalkAction("fecaff265439c-56c4-41gsh4475-8204-7f38adfagdsa3b0878")
						{
							DelayInSeconds = 3.0,
							TalkPriority = TalkAction.TalkActionPriority.Normal,
							CanTalkWhileFighting = false,
				...
				new ActionSetType("0af71asfd32545yupp-sdfqcxb-9c47-de1f2fdcb2c2")
				{
					...
					Actions = new EventActionType[2]
					{
						new TalkAction("3729afs2354uopp4e48-9445-39d4d79c959f")
						{
							TalkPriority = TalkAction.TalkActionPriority.Normal,
							CanTalkWhileFighting = false,
							CanTalkWhileSleeping = false,
		...
		list.Add(new ActionSets
		{
			...
			SetsOfActions = new ActionSetType[1]
			{
				new ActionSetType("3c89f1dgjdhdadetghjey340db9")
				{
					Actions = new EventActionType[1]
					{
						new SpawnEntityAction("37e4a4eghhhhhhhhhhhhffgfgffgc5238ef9a")
						{
							DelayInSeconds = 1.0,
							EntityData = new EntityData
							{
								EntityKey = "terrain:terrainBlockerWide",
								Name = "territoryLockClaypit",
								Location = new Vector3(1560f, 1370f, 0f)
							}
						}
					}
				}
				...
				new ActionSetType("sxdza5fsghgfsjghsjdgjdg0f0d1e4b2a55")
				{
					...
					Actions = new EventActionType[2]
					{
						...
						new TalkAction("f3f4209f-a0a5-4eyutyu34tdc47271ee0")
						{
							...
							CanTalkWhileThreatened = true,
							ActionByAgent = ActionByAgent.RandomInAllegiance,
							DefaultText = "If they've seen us, we might have to fight them!"
						}
					}
				},
				new ActionSetType("a5232bf4tryjdgddkhfjkdhfjkfhjk4bzsae2a55")
				{
					...
					Actions = new EventActionType[2]
					{
						...
						new TalkAction("f3f42retyua34tdcjhkldfghgfhdgfjd47271ee0")
						{
							...
							CanTalkWhileThreatened = true,
							ActionByAgent = ActionByAgent.RandomInAllegiance,
							DefaultText = "We might need to take them on!"
						}
					}
				}
			}
		...
		list.Add(new ActionSets
		{
			...
			SetsOfActions = new ActionSetType[1]
			{
				new ActionSetType("bce52303-d312-4556-b578-1f1dec8dds5555abd")
				{
					Condition = new PlayerAllegiancePersons
					{
						MinMembers = 2
					...
					Actions = new EventActionType[1]
					{
						new TalkAction("9df62c8c-5a7e-47b2-b41b-05693esedrg3e542ab9d4")
						{
							DelayInSeconds = 0.0,
							TalkPriority = TalkAction.TalkActionPriority.Low,
							SpeakerDenomination = TalkAction.SpeakerInConversation.First,
		...
		list.Add(new ActionSets
		{
			...
			SetsOfActions = new ActionSetType[1]
			{
				new ActionSetType("d4b0c097-f997-4111-94d3-28b4ba8d26c02")
				{
					MaxFirings = 1,
					...
					Actions = new EventActionType[2]
					{
						...
						new EventActionDialog("tyudujdgeeeeeeeeetyuetyutyetuityuidtytyhdde4f4e512")
						{
							DelayInSeconds = 3.0,
							DisplayText = new DynamicText
							{
								Text = "-Now, mudbricks can of course dry in the sun but firing them in the kiln is quicker. So let's see if we can keep the kiln burning round the clock, huh? Let's fire a batch of 3 mudbricks. Start by digging more clay and gathering firewood. \n-To speed up things, someone should make some more brick molds. \n \n- // Fire 3X Mudbricks //"
							},
							DisplayImage = "GroupMeeting",
		...
		list.Add(new ActionSets
		{
			...
			SetsOfActions = new ActionSetType[1]
			{
				new ActionSetType("d4b0c097-dtyjudtysj6e8b4ba8d26c02")
				{
					MaxFirings = 1,
					Condition = new ConditionFunction
					{
					...
					Actions = new EventActionType[2]
					{
						...
						new EventActionDialog("53sgfhhhghjktyrkutejitdesyjurstyuhrstghfghfhg51")
						{
							DelayInSeconds = 3.0,
							DisplayText = new DynamicText
							{
								Text = "Right, that's the first batch from the kiln... Get those mudbricks over to the port and let's continue working. I'm sure one more kiln would speed things up. Each time we have 40 mudbricks we'll signal the barge to come and get those in exchange for food. \nThe quicker we get this done, the quicker we can get a bite to eat. \n \n- // Place Mudbricks in port. Stock 40X Mudbricks // -"
							},
							DisplayImage = "GroupMeeting",
							DialogOptions = new DialogOption[1]
							{
			...
			SetsOfActions = new ActionSetType[1]
			{
				new ActionSetType("51xxdfsgdfsghdfshadgfhdfasgdafgdafgdfad88b")
				{
					...
					Actions = new EventActionType[3]
					{
						...
						new EventActionDialog("53sgfhhhhhhhhhhhhhhhhhhhghfghfghfhsdg51")
						{
							DelayInSeconds = 2.0,
							DisplayText = new DynamicText
							{
								Text = "Alright. As soon as we got 40 mudbricks in the port, we'll signal the barge to come and pick them up. In exchange, we should buy as many provisions as we can afford. Let's take the cheap oil tubers, none of that fancy food! \n \n- // Sell Mudbricks. Buy Oil tubers. // -"
							},
							DisplayImage = "GroupMeeting",
							DialogOptions = new DialogOption[1]
							{
		...
		list.Add(new ActionSets
		{
			KeyName = "makeMoreMudBricksDelayEvent",
			SetsOfActions = new ActionSetType[1]
			{
				new ActionSetType("51xgfshssssssssssssssssssgddwhffghgfhhgf9d88b")
				{
					...
					Actions = new EventActionType[1]
					{
						new EventActionDialog("53z5367777777777777787565656565656dwd56565656e4f4e51")
						{
							...
							DisplayText = new DynamicText
							{
								Text = "-I see a lot of people standing around. Hop to it! We need to make and sell as many mudbricks as possible. \n \n- // Continue making and trading mudbricks // -"
							},
							DisplayImage = "GroupMeeting",
							DialogOptions = new DialogOption[1]
							{
								...
								{
									Text = "GUIDE #5",
									Tooltip = "See how to carry out this decision (will open another window)",
									ActiveInArchive = true,
		...
		list.Add(new ActionSets
		{
			KeyName = "continueGameEvent",
			FireMode = ActionSetsToFire.AllValid,
			SetsOfActions = new ActionSetType[1]
			{
				new ActionSetType("51xxdfsgdryhjddgdafgdgggfad88b")
				{
					Condition = new PlayerAllegiancePersons
					{
						MinMembers = 2
					...
					{
						new TalkAction("9xwrtyuregjgfshjeyydtjdtsyjshghghs08")
						{
							DelayInSeconds = 0.0,
							ActionByAgent = ActionByAgent.RandomInAllegiance,
							TalkPriority = TalkAction.TalkActionPriority.High,
		...
		list.Add(new ActionSets
		{
			...
			SetsOfActions = new ActionSetType[1]
			{
				new ActionSetType("645teyujtey7teytjtjdgj8sd2b")
				{
					Actions = new EventActionType[1]
					{
						new ShowTutorialAction("01f2dghjtytejtujktdejdtjtyjdgsdfgd7d2f30")
						{
		...
		list.Add(new ActionSets
		{
			...
			SetsOfActions = new ActionSetType[1]
			{
				new ActionSetType("645teyujtey7teytasdjtjdgj8sd2b")
				{
					Actions = new EventActionType[1]
					{
						new ShowTutorialAction("01f2dghjtytejtujktdejdsadtjtyjdgsdfgd7d2f30")
						{
		...
		list.Add(new ActionSets
		{
			...
			SetsOfActions = new ActionSetType[1]
			{
				new ActionSetType("645teyujtey7tesdasytasdjtjdgj8sd2b")
				{
					Actions = new EventActionType[1]
					{
						new ShowTutorialAction("01f2dghjtytejtujdwktdejdsadtjtyjdgsdfgd7d2f30")
						{
		...
		list.Add(new ActionSets
		{
			...
			SetsOfActions = new ActionSetType[1]
			{
				new ActionSetType("645wteyujtey7teytaawasdjtjdgj8sd2b")
				{
					Actions = new EventActionType[1]
					{
						new ShowTutorialAction("01f2dghjtytejtsdfujktdejdsadtjtyjdgsdfgd7d2f30")
						{
		...
		list.Add(new ActionSets
		{
			...
			SetsOfActions = new ActionSetType[1]
			{
				new ActionSetType("645teyujtey7teytasdjtsadjdgj8sd2b")
				{
					Actions = new EventActionType[1]
					{
						new ShowTutorialAction("01f2dghjtytejtujktdejdsadtjsdsdtyjdgsdfgd7d2f30")
						{
		...
		list.Add(new ActionSets
		{
			...
			SetsOfActions = new ActionSetType[1]
			{
				new ActionSetType("645teyu546756y7uwrtyurtywuwryuwsd2b")
				{
					Actions = new EventActionType[1]
					{
						new ShowTutorialAction("01f2dghjtrwtysrtyhrt6rtsyrtydtyjdgsdfgd7d2f30")
						{
		...
		list.Add(new ActionSets
		{
			...
			SetsOfActions = new ActionSetType[1]
			{
				new ActionSetType("ea39rsgthysrthnjes5y7tyrshsrfhfsgha3933")
				{
					MaxFirings = 1,
					Actions = new EventActionType[7]
					{
						new SpawnEntityAction("1e5kmjnbfhvchuxchcxjhjsqwererppjsrtyureseyurw79b9")
						{
							DelayInSeconds = 2.0,
							EntityData = new EntityData
							{
								...
								Location = new Vector3(778f, 772f, 0f),
						...
						new SpawnEntityAction("1e5kmvhbhgdhgdetrppejjhdgzxxzzgehjsrtyureseyurw79b9")
						{
							DelayInSeconds = 3.0,
							EntityData = new EntityData
							{
								...
								Location = new Vector3(800f, 780f, 0f),
								BioEntity = new UWGame.SimSide.Maps.MapEditor.BiologicalEntity
								{
									AgeGroup = AIAgeGroup.Adult
								}
						...
						new SpawnEntityAction("1e5dtgfjuhy56euuurghsfgseyurw79b9")
						{
							DelayInSeconds = 4.0,
							EntityData = new EntityData
							{
						...
						new SpawnEntityAction("1e5dtgfjuhy56esfghsfghjsrtyureseyurw79b9")
						{
							DelayInSeconds = 2.0,
							EntityData = new EntityData
							{
								...
								Location = new Vector3(816f, 816f, 0f),
								BioEntity = new UWGame.SimSide.Maps.MapEditor.BiologicalEntity
								{
									AgeGroup = AIAgeGroup.Adult
								}
						...
						new SpawnEntityAction("1e5dtsfghgfs56euuutdgehjsrtyureseyurw79b9")
						{
							DelayInSeconds = 1.0,
							EntityData = new EntityData
							{
						...
						new SpawnEntityAction("1e5dtgsfghgfsh56euuutdgehjsrtyureseyurw79b9")
						{
							DelayInSeconds = 2.0,
							EntityData = new EntityData
							{
								...
								Location = new Vector3(864f, 836f, 0f),
								BioEntity = new UWGame.SimSide.Maps.MapEditor.BiologicalEntity
								{
									AgeGroup = AIAgeGroup.Adult
								}
						...
						new SpawnEntityAction("1e5dtgfjghkdhfjkhfj6euuutdgehjsrtyureseyurw79b9")
						{
							DelayInSeconds = 2.5,
							EntityData = new EntityData
							{
		...
		list.Add(new ActionSets
		{
			...
			SetsOfActions = new ActionSetType[1]
			{
				new ActionSetType("ea39rsgthysrthdrghjdfgjdjhsrfhfsgha3933")
				{
					MaxFirings = 1,
					Actions = new EventActionType[6]
					{
						new SpawnEntityAction("1e5ddjdw79hjklhjlhjlhjb9")
						{
							DelayInSeconds = 2.0,
							EntityData = new EntityData
							{
								...
								Location = new Vector3(2037f, 1809f, 0f),
								BioEntity = new UWGame.SimSide.Maps.MapEditor.BiologicalEntity
								{
									AgeGroup = AIAgeGroup.Adult
								}
						...
						new SpawnEntityAction("1e5dtgfjuhy56dghjdgjdtyureseyurw79b9")
						{
							DelayInSeconds = 3.0,
							EntityData = new EntityData
							{
						...
						new SpawnEntityAction("1e5dtgdrsy6thrustyhu6ryrghsfgseyurw79b9")
						{
							DelayInSeconds = 4.0,
							EntityData = new EntityData
							{
						...
						new SpawnEntityAction("1e5dtgfjuhy56esfghsoir7r867oreseyurw79b9")
						{
							DelayInSeconds = 2.0,
							EntityData = new EntityData
							{
						...
						new SpawnEntityAction("1e5dtsfryuiryuirehjsryuiryui79b9")
						{
							DelayInSeconds = 1.0,
							EntityData = new EntityData
							{
						...
						new SpawnEntityAction("1e5dtsfryurtyuetyutui79b9")
						{
							DelayInSeconds = 1.0,
							EntityData = new EntityData
							{
