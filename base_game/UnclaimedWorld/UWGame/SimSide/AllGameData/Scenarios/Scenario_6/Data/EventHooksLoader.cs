...
public class EventHooksLoader
{
	...
	public static List<AgentActionHook> InitAgentActionHooks()
	{
		return new List<AgentActionHook>
		{
			...
			new AgentActionHook
			{
				...
				ActionSetsKey = "newPlayerAllegianceMemberRemark"
			}
		};
	}
	...
	public static List<ProcessTypeActionHook> InitProcessTypeHooks()
	{
		return new List<ProcessTypeActionHook>
		{
			...
			{
				KeyName = "constructKilnFinished",
				TypeKey = "constructKiln",
				Hook = AgentActionHooks.CompletedProducing,
				ActionSetsKey = "constructKilnFinishedEvent"
			},
			new ProcessTypeActionHook
			{
				KeyName = "makeSolidMudBrickFinished",
				TypeKey = "makeSolidMudBrick",
				Hook = AgentActionHooks.CompletedProducing,
				ActionSetsKey = "makeSolidMudBrickFinishedEvent"
			},
			new ProcessTypeActionHook
			{
			...
			new ProcessTypeActionHook
			{
				KeyName = "startGatherClayHook",
				TypeKey = "gatherClay",
				Hook = AgentActionHooks.StartProducing,
				ActionSetsKey = "startGatherClayRemark"
			},
			new ProcessTypeActionHook
			{
