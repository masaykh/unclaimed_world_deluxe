...
public class TutorialLoader
{
	public static List<HelpTopic> Init()
	{
		...
		list.Add(new HelpTopic
		{
			...
			FlowElements = new LayoutElement[10]
			{
				new LayoutElement
				{
					Text = new TextElement
					{
						Text = Label.ToLabel("GUIDE #1 - HIRE A BARGE", "#COLORHEADER") + "\n \nFirst, click the MISSIONS button:"
					}
				},
				new LayoutElement
				{
				...
				new LayoutElement
				{
					Image = new ImageElement
					{
						Image = "tutRubber_selectEdenPlains"
					}
				},
				new LayoutElement
				{
		...
		list.Add(new HelpTopic
		{
			...
			FlowElements = new LayoutElement[9]
			{
				new LayoutElement
				{
					Text = new TextElement
					{
						Text = Label.ToLabel("GUIDE #2a - BUILD GENERAL WORKSHOP", "#COLORHEADER")
					}
				},
				new LayoutElement
				{
					Image = new ImageElement
					{
						Image = "tutRubber_polymerWorkshopTooltip"
					}
				},
				new LayoutElement
				{
				...
				new LayoutElement
				{
					Text = new TextElement
					{
						Text = Label.ToLabel("GUIDE #2b - UPGRADE WORKSHOP", "#COLORHEADER")
					}
				},
				new LayoutElement
				{
					Image = new ImageElement
					{
						Image = "tutRubber_upgradeWorkshop"
					}
				},
				new LayoutElement
				{
				...
				new LayoutElement
				{
					Text = new TextElement
					{
						Text = Label.ToLabel("GUIDE #2c - PRODUCE RUBBER PARTS", "#COLORHEADER")
					}
				},
				new LayoutElement
				{
					Image = new ImageElement
					{
						Image = "tutRubber_rubberPartsTooltip"
					}
				},
				new LayoutElement
				{
		...
		list.Add(new HelpTopic
		{
			...
			FlowElements = new LayoutElement[5]
			{
				new LayoutElement
				{
					Text = new TextElement
					{
						Text = Label.ToLabel("GUIDE #3 - SELL RUBBER PARTS", "#COLORHEADER")
					}
				},
				new LayoutElement
				{
					Image = new ImageElement
					{
						Image = "tutRubber_portRubberParts"
					}
				},
				new LayoutElement
				{
