	...
	public static List<EventActionType> Init()
	{
		...
		list.Add(new SpawnSiteAction
		{
			...
			SiteData = new SiteData
			{
				...
				Coords = new GeodeticCoordinate(9.3, 71.9),
				IsPlaySite = true,
				ShowLabel = true,
				ShowTallPin = true,
				SiteMarkerOrder = 10
		...
		list.Add(new SpawnSiteAction
		{
			...
			SiteData = new SiteData
			{
				...
				Coords = new GeodeticCoordinate(9.212, 71.8),
				IsPlaySite = false,
				ShowLabel = false,
				ShowTallPin = false
			}
		...
		list.Add(ScenarioLoader.SpawnItemAtStartLocation("startShingles", new Vector2(x5, y5), "item:spoakShingles", "playerAllegiance", null, num));
		list.Add(ScenarioLoader.SpawnItemAtStartLocation("startMudbricks", new Vector2(x5, y5), "item:solidMudBrick", "playerAllegiance", null, num));
		list.Add(ScenarioLoader.SpawnItemAtStartLocation("startSpoakTrimmed", new Vector2(x5, y5), "item:spoakBranchesTrimmed", "playerAllegiance", null, num));
		list.Add(ScenarioLoader.SpawnItemAtStartLocation("startMetalLatheComponents", new Vector2(x5, y5), "item:metalLatheComponents", "playerAllegiance", null, num));
		list.Add(ScenarioLoader.SpawnItemAtStartLocation("startHumanPowerUnit", new Vector2(x5, y5), "item:humanPowerUnit", "playerAllegiance", null, num));
		list.Add(ScenarioLoader.SpawnItemAtStartLocation("startBlisterSteel", new Vector2(x5, y5), "item:blisterSteel", "playerAllegiance", null, num));
		list.Add(ScenarioLoader.SpawnItemAtStartLocation("startWroughtIron", new Vector2(x5, y5), "item:wroughtIron", "playerAllegiance", null, num));
		list.Add(ScenarioLoader.SpawnItemAtStartLocation("startChickenTannedHide", new Vector2(x5, y5), "item:thunderChickenTannedHide", "playerAllegiance", null, num));
		list.Add(ScenarioLoader.SpawnItemAtStartLocation("startExtrusionMachine", new Vector2(x5, y5), "item:extrusionMachineComponents", "playerAllegiance", null, num));
		list.Add(ScenarioLoader.SpawnItemAtStartLocation("startLoomComponents", new Vector2(x5, y5), "item:loomComponents", "playerAllegiance", null, num));
		list.Add(ScenarioLoader.SpawnItemAtStartLocation("startScrapMetal", new Vector2(x5, y5), "item:scrapMetal", "playerAllegiance", null, num));
		...
		list.Add(ScenarioLoader.SpawnItemAtStartLocation("startshadeleafCanesTest", new Vector2(x5, y5), "item:shadeleafCanes", "playerAllegiance", null, num, null, null, 20));
		list.Add(ScenarioLoader.SpawnItemAtStartLocation("startDiamondGlass", new Vector2(x5, y5), "item:diamondGlass", "playerAllegiance", null, num, null, null, 10));
		...
		list.Add(ScenarioLoader.SpawnItemAtStartLocation("startCrystalTest", new Vector2(x3, y3), "item:crystalBerries", "playerAllegiance", null, num));
		...
		list.Add(ScenarioLoader.SpawnItemAtStartLocation("startCottonTest", new Vector2(x3, y3), "item:cotton", "playerAllegiance", null, num));
		...
		list.Add(ScenarioLoader.SpawnItemAtStartLocation("startSentry", new Vector2(x4, y4), "item:sentry", "playerAllegiance", null, num));
		list.Add(ScenarioLoader.SpawnItemAtStartLocation("startSentryAmmo", new Vector2(x4, y4), "item:sentryGunAmmo", "playerAllegiance", null, num));
		...
		list.Add(ScenarioLoader.SpawnItemAtStartLocation("startMachete", new Vector2(x2, y2), "item:advancedMachete", "playerAllegiance", null, num));
		list.Add(ScenarioLoader.SpawnItemAtStartLocation("startSnips", new Vector2(x2, y2), "item:advancedSnips", "playerAllegiance", null, num));
		list.Add(ScenarioLoader.SpawnItemAtStartLocation("startString", new Vector2(x2, y2), "item:advancedString", "playerAllegiance", null, num));
		...
		list.Add(ScenarioLoader.SpawnItemAtStartLocation("startKnife", new Vector2(x2, y2), "item:steelKnife", "playerAllegiance", null, num));
		list.Add(ScenarioLoader.SpawnItemAtStartLocation("startCookingPot", new Vector2(x2, y2), "item:advancedCookingPot", "playerAllegiance", null, num));
		...
		list.Add(ScenarioLoader.SpawnItemAtStartLocation("startCottonString", new Vector2(x2, y2), "item:cottonString", "playerAllegiance", null, num));
		list.Add(ScenarioLoader.SpawnItemAtStartLocation("startFishingNet", new Vector2(x2, y2), "item:fishingNet", "playerAllegiance", null, num));
		...
		list.Add(ScenarioLoader.SpawnItemAtStartLocation("startImprovisedGreenHouseCover", new Vector2(x5, y5), "item:improvisedGreenHouseCover", "playerAllegiance", null, num, null, null, 4));
		...
		list.Add(new SetPropertyAction
		{
			KeyName = "setStartingLocationSouthBank",
			PropertyKey = "startingLocation",
			Value = new ValueNode
			{
				Location = new Vector2(2596f, 2461f)
			}
		});
		list.Add(new SetPropertyAction
		{
			KeyName = "setStartingLocationWestArableLand",
			PropertyKey = "startingLocation",
			Value = new ValueNode
			{
				Location = new Vector2(1310f, 1730f)
			}
		});
		list.Add(new SetPropertyAction
		{
			KeyName = "setStartingLocationCenterMudBank",
			PropertyKey = "startingLocation",
			Value = new ValueNode
			{
				Location = new Vector2(2100f, 1280f)
			}
		});
		...
		list.Add(new ExploreAction
		{
			...
			RadiusEnd = 500f,
			DetectMode = DetectMode.DetectAlwaysSeenEntities,
			OffsetLocationEnd = new Vector2(3500f, 3076f),
			EntityToExploreWith = new TargetObject
			{
				GetList = new GetList
				{
		...
		list.Add(new SpawnAllegianceAction
		{
			...
			ExpeditionData = new ExpeditionData
			{
				...
				Location = new ValueNode
				{
					Location = new Vector2(3120f, 2496f)
				},
		...
		list.Add(new SpawnAllegianceAction
		{
			...
			ExpeditionData = new ExpeditionData
			{
				...
				Location = new ValueNode
				{
					Location = new Vector2(3534f, 288f)
				},
				PopulationData = new PopulationData
				{
		...
		list.Add(new SpawnAllegianceAction
		{
			...
			ExpeditionData = new ExpeditionData
			{
				...
				Location = new ValueNode
				{
					Location = new Vector2(480f, 1008f)
				},
				PopulationData = new PopulationData
				{
					SpawnRadius = 150f,
		...
		list.Add(new SpawnAllegianceAction
		{
			...
			ExpeditionData = new ExpeditionData
			{
				...
				Location = new ValueNode
				{
					Location = new Vector2(1680f, 2064f)
				},
				PopulationData = new PopulationData
				{
					MaxMembers = 4,
		...
		list.Add(new SpawnAllegianceAction
		{
			...
			ExpeditionData = new ExpeditionData
			{
				...
				Location = new ValueNode
				{
					Location = new Vector2(3312f, 3168f)
				},
				PopulationData = new PopulationData
				{
					SpawnRadius = 150f,
		...
		list.Add(new SpawnAllegianceAction
		{
			...
			ExpeditionData = new ExpeditionData
			{
				...
				Location = new ValueNode
				{
					Location = new Vector2(2112f, 192f)
				},
				PopulationData = new PopulationData
				{
					MaxMembers = 1,
		...
		list.Add(new SpawnAllegianceAction
		{
			...
			ExpeditionData = new ExpeditionData
			{
				...
				Location = new ValueNode
				{
					Location = new Vector2(3024f, 1008f)
				},
				PopulationData = new PopulationData
				{
					MaxMembers = 1,
		...
		list.Add(new SpawnAllegianceAction
		{
			...
			ExpeditionData = new ExpeditionData
			{
				...
				Location = new ValueNode
				{
					Location = new Vector2(3072f, 3690f)
				},
				PopulationData = new PopulationData
				{
					MaxMembers = 1,
		...
		list.Add(new SpawnAllegianceAction
		{
			...
			ExpeditionData = new ExpeditionData
			{
				...
				Location = new ValueNode
				{
					Location = new Vector2(490f, 2910f)
				},
				PopulationData = new PopulationData
				{
					MaxMembers = 1,
		...
		list.Add(new SpawnAllegianceAction
		{
			...
			ExpeditionData = new ExpeditionData
			{
				...
				Location = new ValueNode
				{
					Location = new Vector2(2880f, 960f)
				},
				PopulationData = new PopulationData
				{
					MaxMembers = 5,
		...
		list.Add(new SpawnAllegianceAction
		{
			...
			ExpeditionData = new ExpeditionData
			{
				...
				Location = new ValueNode
				{
					Location = new Vector2(1824f, 2592f)
				},
				PopulationData = new PopulationData
				{
		...
		list.Add(new SpawnAllegianceAction
		{
			...
			ExpeditionData = new ExpeditionData
			{
				...
				Location = new ValueNode
				{
					Location = new Vector2(2112f, 2256f)
				},
				PopulationData = new PopulationData
				{
		...
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				...
				Name = "Small plot 1",
				Location = new Vector3(2024f, 2326f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:smallPlotSpot",
				Name = "Small plot 2",
				Location = new Vector3(2225f, 2359f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:smallPlotSpot",
				Name = "Small plot 3",
				Location = new Vector3(2058f, 2466f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:smallPlotSpot",
				Name = "Small plot 4",
				Location = new Vector3(1081f, 1748f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:smallPlotSpot",
				Name = "Small plot 5",
				Location = new Vector3(727f, 1921f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:smallPlotSpot",
				Name = "Small plot 6",
				Location = new Vector3(949f, 1608f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:smallPlotSpot",
				Name = "Small plot 7",
				Location = new Vector3(2282f, 1165f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				...
				Name = "Large plot 1",
				Location = new Vector3(1050f, 1986f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:largePlotSpot",
				Name = "Large plot 2",
				Location = new Vector3(834f, 1766f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:largePlotSpot",
				Name = "Large plot 3",
				Location = new Vector3(1775f, 2388f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
		...
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				...
				Name = "Pier spot",
				Location = new Vector3(1586f, 1832f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:pierSpot",
				Name = "Pier spot",
				Location = new Vector3(2762f, 2622f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:pierSpot",
				Name = "Pier spot",
				Location = new Vector3(2274f, 1432f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				...
				Name = "Fish weir spot (504f, 588f)",
				Location = new Vector3(504f, 588f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			{
				EntityKey = "terrain:fishTrapSpotCreek",
				Name = "Fish weir spot (1660f, 1702f)",
				Location = new Vector3(1660f, 1702f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			{
				EntityKey = "terrain:fishTrapSpotCreek",
				Name = "Fish weir spot (1090f, 2700f)",
				Location = new Vector3(1090f, 2700f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				...
				Location = new Vector3(2380f, 3200f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				...
				Location = new Vector3(920f, 1256f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:fishTrapSpotShore",
				Name = "Fish trap spot Freshwater",
				Location = new Vector3(1110f, 852f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:fishTrapSpotShore",
				Name = "Fish trap spot Freshwater",
				Location = new Vector3(1808f, 1586f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:fishTrapSpotShore",
				Name = "Fish trap spot Freshwater",
				Location = new Vector3(2422f, 1592f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:fishTrapSpotShore",
				Name = "Fish trap spot Freshwater",
				Location = new Vector3(2716f, 2006f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:fishTrapSpotShore",
				Name = "Fish trap spot Freshwater",
				Location = new Vector3(2616f, 2728f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:fishTrapSpotShore",
				Name = "Fish trap spot Freshwater",
				Location = new Vector3(2952f, 2936f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:fishTrapSpotShore",
				Name = "Fish trap spot Freshwater",
				Location = new Vector3(3496f, 2088f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:fishTrapSpotShore",
				Name = "Fish trap spot Freshwater",
				Location = new Vector3(3425f, 2594f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				...
				Location = new Vector3(1768f, 3516f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				...
				Name = "Peat deposit",
				Location = new Vector3(2044f, 2688f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:peatDeposit",
				Name = "Peat deposit",
				Location = new Vector3(520f, 1808f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				...
				Name = "Salt deposit",
				Location = new Vector3(440f, 280f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				...
				Name = "Clay deposit",
				Location = new Vector3(1900f, 1280f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = new Vector2(1392f, 3000f)
			},
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = new Vector2(1008f, 2670f)
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = new Vector2(1828f, 2022f)
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = new Vector2(2372f, 1738f)
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = new Vector2(2688f, 1872f)
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = new Vector2(922f, 1310f)
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = new Vector2(1152f, 624f)
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = MapManager.TileToWorldPosVector2(new Point(57, 64))
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = MapManager.TileToWorldPosVector2(new Point(61, 69))
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = MapManager.TileToWorldPosVector2(new Point(65, 67))
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = MapManager.TileToWorldPosVector2(new Point(73, 58))
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = MapManager.TileToWorldPosVector2(new Point(68, 70))
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = MapManager.TileToWorldPosVector2(new Point(74, 75))
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = MapManager.TileToWorldPosVector2(new Point(73, 56))
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = new Vector2(288f, 2900f)
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = new Vector2(768f, 3312f)
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = new Vector2(288f, 2928f)
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = new Vector2(720f, 3312f)
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
