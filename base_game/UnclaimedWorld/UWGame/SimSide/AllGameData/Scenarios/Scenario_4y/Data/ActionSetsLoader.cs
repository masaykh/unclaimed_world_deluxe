				...
				new ActionSetType("1df356eyurtyhrtysurykykyk7w756a91")
				{
					...
					Actions = new EventActionType[2]
					{
						...
						new TalkAction("fecd467867ejuidtjdtsyhjuyty0878")
						{
							...
							ActionByAgent = ActionByAgent.RandomInAllegiance,
							DefaultText = "They'll be heading towards the swamp. Let's catch some!"
						}
					}
				},
					...
					Actions = new EventActionType[10]
					{
						...
						new SpawnEntityAction("d7tdyujkdgjdjdjdtyju498")
						{
							...
							EntityData = new EntityData
							{
								...
								Location = new Vector3(480f, 28f, 0f),
								Bulk = 0.3f,
						...
						new SpawnEntityAction("6f04678674864786476reuijte7jdtyj8950f1")
						{
							...
							EntityData = new EntityData
							{
								...
								Location = new Vector3(480f, 48f, 0f),
								Bulk = 0.3f,
								BioEntity = new UWGame.SimSide.Maps.MapEditor.BiologicalEntity
								{
									AgeGroup = AIAgeGroup.Adult
						...
						new SpawnEntityAction("04961fdtyjdt7tjddgtde56jueac51bd4")
						{
							...
							EntityData = new EntityData
							{
								...
								Location = new Vector3(480f, 96f, 0f),
								Bulk = 0.3f,
								BioEntity = new UWGame.SimSide.Maps.MapEditor.BiologicalEntity
								{
									AgeGroup = AIAgeGroup.Adult
						...
						new SpawnEntityAction("ea7srtdtyjt76u6rudtyjudtub61b2c")
						{
							...
							EntityData = new EntityData
							{
								...
								Location = new Vector3(480f, 144f, 0f),
								Bulk = 0.3f,
								BioEntity = new UWGame.SimSide.Maps.MapEditor.BiologicalEntity
								{
									AgeGroup = AIAgeGroup.Adult
						...
						new SpawnEntityAction("043q456t34q56tae5456jueac51bd4")
						{
							...
							EntityData = new EntityData
							{
								...
								Location = new Vector3(480f, 192f, 0f),
								Bulk = 0.3f,
								BioEntity = new UWGame.SimSide.Maps.MapEditor.BiologicalEntity
								{
									AgeGroup = AIAgeGroup.Adult
						...
						new SpawnEntityAction("4d54w6rewtyrsetysyaee6ue8588213")
						{
							...
							EntityData = new EntityData
							{
								...
								Location = new Vector3(432f, 144f, 0f),
								Bulk = 0.3f,
								BioEntity = new UWGame.SimSide.Maps.MapEditor.BiologicalEntity
								{
									AgeGroup = AIAgeGroup.Adult
						...
						new SpawnEntityAction("04961fdt4fxgyhnj6rtysthj6w4ysr45y54wac51bd4")
						{
							...
							EntityData = new EntityData
							{
								...
								Location = new Vector3(432f, 96f, 0f),
								Bulk = 0.3f,
								BioEntity = new UWGame.SimSide.Maps.MapEditor.BiologicalEntity
								{
									AgeGroup = AIAgeGroup.Adult
						...
						new SpawnEntityAction("easr45yrs5t6tdfydstyasetyrsttub61b2c")
						{
							...
							EntityData = new EntityData
							{
								...
								Location = new Vector3(528f, 48f, 0f),
								Bulk = 0.3f,
								BioEntity = new UWGame.SimSide.Maps.MapEditor.BiologicalEntity
								{
									AgeGroup = AIAgeGroup.Adult
						...
						new SpawnEntityAction("4dwrsrty64y765674w5767455464yw213")
						{
							...
							EntityData = new EntityData
							{
								...
								Location = new Vector3(432f, 55f, 0f),
								Bulk = 0.3f,
								BioEntity = new UWGame.SimSide.Maps.MapEditor.BiologicalEntity
								{
									AgeGroup = AIAgeGroup.Adult
					...
					Actions = new EventActionType[8]
					{
						...
						new SpawnEntityAction("d75675637856e78563785787867498")
						{
							...
							EntityData = new EntityData
							{
								...
								Location = new Vector3(2064f, 48f, 0f),
								Bulk = 0.3f,
								BioEntity = new UWGame.SimSide.Maps.MapEditor.BiologicalEntity
								{
									AgeGroup = AIAgeGroup.Adult
						...
						new SpawnEntityAction("6f0467867486478647864786748950f1")
						{
							...
							EntityData = new EntityData
							{
								...
								Location = new Vector3(2044f, 48f, 0f),
								Bulk = 0.3f,
								BioEntity = new UWGame.SimSide.Maps.MapEditor.BiologicalEntity
								{
									AgeGroup = AIAgeGroup.Adult
						...
						new SpawnEntityAction("04961f4c-9srtyues5e6rue56jueac51bd4")
						{
							...
							EntityData = new EntityData
							{
								...
								Location = new Vector3(2084f, 48f, 0f),
								Bulk = 0.3f,
								BioEntity = new UWGame.SimSide.Maps.MapEditor.BiologicalEntity
								{
									AgeGroup = AIAgeGroup.Adult
						...
						new SpawnEntityAction("ea7srtyuh65e78uerthjryuyryub61b2c")
						{
							...
							EntityData = new EntityData
							{
								...
								Location = new Vector3(2104f, 48f, 0f),
								Bulk = 0.3f,
								BioEntity = new UWGame.SimSide.Maps.MapEditor.BiologicalEntity
								{
									AgeGroup = AIAgeGroup.Adult
						...
						new SpawnEntityAction("sfgjghfnjxdyrtjdrtyjds67498")
						{
							...
							EntityData = new EntityData
							{
								...
								Location = new Vector3(2016f, 96f, 0f),
								Bulk = 0.3f,
								BioEntity = new UWGame.SimSide.Maps.MapEditor.BiologicalEntity
								{
									AgeGroup = AIAgeGroup.Adult
						...
						new SpawnEntityAction("sfgjhnxdgtrydtjufghx48950f1")
						{
							...
							EntityData = new EntityData
							{
								...
								Location = new Vector3(2064f, 96f, 0f),
								Bulk = 0.3f,
								BioEntity = new UWGame.SimSide.Maps.MapEditor.BiologicalEntity
								{
									AgeGroup = AIAgeGroup.Adult
						...
						new SpawnEntityAction("dhjxghnjxrsyhjugfshsfgheac51bd4")
						{
							...
							EntityData = new EntityData
							{
								...
								Location = new Vector3(2112f, 96f, 0f),
								Bulk = 0.3f,
								BioEntity = new UWGame.SimSide.Maps.MapEditor.BiologicalEntity
								{
									AgeGroup = AIAgeGroup.Adult
		...
		list.Add(new ActionSets
		{
			...
			SetsOfActions = new ActionSetType[4]
			{
				new ActionSetType("d925515-3a701d-asfafb98-447d-9b02-7cccbfbe39f5")
				{
					...
					{
						new SpawnEntityAction("eduyogytf63ea9-euyyyoug4e2-4c37-8312-7ce1944a9d9e")
						{
							DelayInSeconds = 0.1,
							EntityData = new EntityData
							{
				...
				new ActionSetType("e8e3aed9-7e56-sg46264egse-8ad9-ac28f14ab0c1")
				{
					Actions = new EventActionType[1]
					{
						new SpawnEntityAction("d5e5a91c-0f8d-4cgjkuuioip0-a924-ef7e14b3e21b")
						{
							DelayInSeconds = 0.1,
							EntityData = new EntityData
							{
				...
				new ActionSetType("d92asfsafa2525701d-ab98-447d-9b05253fa2-7cccbfbe39f5-dwad5")
				{
					Actions = new EventActionType[1]
					{
						new SpawnEntityAction("edf63ipea9-e4e2-hohuotuhjguoupp4c37-8312-7ce1ip944a9d9e")
						{
							DelayInSeconds = 0.1,
							EntityData = new EntityData
							{
				...
				new ActionSetType("e8e3aed9-7e56-43f8-8ad9-ac28sgd22tytupp4ab0c1")
				{
					Actions = new EventActionType[1]
					{
						new SpawnEntityAction("d5e5a91c-0f8d-4cf0-a924-ef532twrgtyiupsfq3e21b")
						{
							DelayInSeconds = 0.1,
							EntityData = new EntityData
							{
		...
		list.Add(new ActionSets
		{
			...
			SetsOfActions = new ActionSetType[4]
			{
				new ActionSetType("ef6e8bef-0afb-4b0saf325f-8365-50ad3f301eba")
				{
					Actions = new EventActionType[1]
					{
						new SpawnEntityAction("1575ee05-443b-4fas235235fa-b379-d3dbf9d99229")
						{
							DelayInSeconds = 0.1,
							EntityData = new EntityData
							{
				...
				new ActionSetType("9833b74b-51hyungniiiim20-4181-bea8-d0f7405c7d50")
				{
					Actions = new EventActionType[1]
					{
						new SpawnEntityAction("25ee2bc6-e7cf-4af224369-8644-945ce9e56ba4")
						{
							DelayInSeconds = 0.1,
							EntityData = new EntityData
							{
				...
				new ActionSetType("ef6e8bef-0afb-4b0f-83asf23532-50ad3f301eba")
				{
					Actions = new EventActionType[1]
					{
						new SpawnEntityAction("1575ee05-443b-431b-bf32t4wegae-d3dbf9d99229")
						{
							DelayInSeconds = 0.1,
							EntityData = new EntityData
							{
				...
				new ActionSetType("9833asf325b74b-5120-4181-bea8-d0f7405c7d50")
				{
					Actions = new EventActionType[1]
					{
						new SpawnEntityAction("25ee2bc6-e7cf-4a79-8fsa2362644-945ce9e56ba4")
						{
							DelayInSeconds = 0.1,
							EntityData = new EntityData
							{
		...
		list.Add(new ActionSets
		{
			...
			SetsOfActions = new ActionSetType[2]
			{
				new ActionSetType("3eae1eb9-fd76-4asf235236-9a12-526b2250e1a2")
				{
					Actions = new EventActionType[1]
					{
						new SpawnEntityAction("4906cf65-f9f8-4fahdzf0-8dd9-3f0d081b487e")
						{
							DelayInSeconds = 0.1,
							EntityData = new EntityData
							{
								...
								Location = new Vector3(3792f, 576f, 0f),
								Bulk = 2f,
								BioEntity = new UWGame.SimSide.Maps.MapEditor.BiologicalEntity
								{
									AgeGroup = AIAgeGroup.Adult
					...
					Actions = new EventActionType[1]
					{
						new SpawnEntityAction("a2dd9aef-2011-4673-a7ca-99cf7a72c7c3")
						{
							...
							EntityData = new EntityData
							{
								...
								Location = new Vector3(3792f, 1248f, 0f),
								Bulk = 2f,
								BioEntity = new UWGame.SimSide.Maps.MapEditor.BiologicalEntity
								{
									AgeGroup = AIAgeGroup.Adult
		...
		list.Add(new ActionSets
		{
			...
			SetsOfActions = new ActionSetType[1]
			{
				new ActionSetType("3eae1eb9-fd76-42b5-9asfehrys2-526b2250e1a2")
				{
					Actions = new EventActionType[1]
					{
						new SpawnEntityAction("4906cf65-f9f8-4590-8aawafq9-3f0d081b487e")
						{
							DelayInSeconds = 0.1,
							EntityData = new EntityData
							{
			...
			SetsOfActions = new ActionSetType[3]
			{
				...
				new ActionSetType("d92a70sada252afa3f3ff51d-afdsaf32523-47d-9b02-7cccbfbe39f5")
				{
					Condition = new CustomCondition
					{
						...
						{
							PropertyKey = "name",
							ConstantStringEqual = "Field quadite nest 3"
						}
					},
					Actions = new EventActionType[1]
					{
