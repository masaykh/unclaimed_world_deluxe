		...
		list.Add(new HelpTopic
		{
			...
			FlowElements = new LayoutElement[3]
			{
				...
				new LayoutElement
				{
					Image = new ImageElement
					{
						Image = "tut_gather1Stone3Firewood"
					}
				},
				new LayoutElement
				{
		...
		list.Add(new HelpTopic
		{
			...
			FlowElements = new LayoutElement[6]
			{
				new LayoutElement
				{
					Text = new TextElement
					{
						Text = Label.ToLabel("GUIDE #8: BUILD CAMPFIRE", "#COLORHEADER") + " \n \n -To build a structure, open the Production Manager:"
					}
				},
				new LayoutElement
				{
				...
				new LayoutElement
				{
					Image = new ImageElement
					{
						Image = "tut_8_buildCampfirePlacement"
					}
				}
			}
		});
		...
		list.Add(new HelpTopic
		{
			...
			FlowElements = new LayoutElement[6]
			{
				new LayoutElement
				{
					Text = new TextElement
					{
						Text = Label.ToLabel("GUIDE #11: CANCEL ALL ACTION ZONES", "#COLORHEADER") + " \n \n -Cancel a zone by clicking the white arrow on the zone marker:"
					}
				},
				new LayoutElement
				{
		...
		list.Add(new HelpTopic
		{
			...
			FlowElements = new LayoutElement[5]
			{
				new LayoutElement
				{
					Text = new TextElement
					{
						Text = Label.ToLabel("GUIDE #12b: MAKE 3 SPEARS (Make 3 spearheads)", "#COLORHEADER") + " \n \n -Open the Production Manager by clicking this button:"
					}
				},
				new LayoutElement
				{
		...
		list.Add(new HelpTopic
		{
			...
			FlowElements = new LayoutElement[3]
			{
				new LayoutElement
				{
					Text = new TextElement
					{
						Text = Label.ToLabel("GUIDE #13: SCOUT FOR BUSH DRAGONS", "#COLORHEADER") + " \n \n -Make a scout zone as indicated in the image."
					}
				},
				new LayoutElement
				{
		...
		list.Add(new HelpTopic
		{
			...
			FlowElements = new LayoutElement[4]
			{
				...
				new LayoutElement
				{
					Image = new ImageElement
					{
						Image = "tut_14_patrolBushDragons"
					}
				},
				new LayoutElement
				{
		...
		list.Add(new HelpTopic
		{
			...
			FlowElements = new LayoutElement[3]
			{
				...
				new LayoutElement
				{
					Image = new ImageElement
					{
						Image = "tut_15_signalPyreProdInfo"
					}
				},
				new LayoutElement
				{
		...
		list.Add(new HelpTopic
		{
			...
			FlowElements = new LayoutElement[3]
			{
				new LayoutElement
				{
					Text = new TextElement
					{
						Text = Label.ToLabel("GUIDE #16: LIGHT SIGNAL PYRE", "#COLORHEADER") + " \n \n -Select the signal pyre, click the arrow and select BEGIN \n \n"
					}
				},
				new LayoutElement
				{
