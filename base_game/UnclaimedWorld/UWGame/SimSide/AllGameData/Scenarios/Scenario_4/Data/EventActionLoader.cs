...
public class EventActionLoader
{
	public static List<EventActionType> Init()
	{
		...
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				Location = new Vector3(-121f, 48f, 0f),
				EntityKey = "entity:human",
				MemberOf = new AllegianceAndExpedition
				{
					AllegianceKey = "playerAllegiance",
				...
				BioEntity = new BiologicalEntity
				{
					TraitTemplates = new StringChance[2]
					{
						new StringChance
						{
							Edge = 0.5f,
		...
		list.Add(ScenarioLoader.SpawnItemAtStartLocation("startStructureRadioHutImprovised", new Vector2(40f, -70f), "structure:radioHutImprovised", "playerAllegiance", null, delay));
		...
		list.Add(new SpawnAllegianceAction
		{
			KeyName = "spawnBushDragonExpeditionSouth",
			Site = "playSite",
			ExpeditionData = new ExpeditionData
			{
				KeyName = "bushDragonAllegianceSouth",
				Name = "Bush Dragon Allegiance South",
				AllegianceKey = "bushDragonAllegianceSouth",
				Location = new ValueNode
				{
					Location = new Vector2(5345f, 5500f)
				}
			},
			AllegianceData = new AllegianceData
			{
		...
		list.Add(new SpawnAllegianceAction
		{
			KeyName = "spawnTwinklerExpeditionNorth",
			Site = "playSite",
			ExpeditionData = new ExpeditionData
			{
				KeyName = "twinklerAllegianceNorth",
				Name = "Twinkler Allegiance North",
				AllegianceKey = "twinklerAllegianceNorth",
				Location = new ValueNode
				{
					Location = new Vector2(4468f, 1100f)
				}
			},
			AllegianceData = new AllegianceData
			{
				ForageAndHuntingRadius = 1300,
				Name = "Twinkler Allegiance North",
				KeyName = "twinklerAllegianceNorth",
		...
		list.Add(new SpawnAllegianceAction
		{
			KeyName = "spawnBinalRatExpeditionSwamp",
			Site = "playSite",
			ExpeditionData = new ExpeditionData
			{
				KeyName = "binalRatAllegianceSwamp",
				Name = "Binal Rat Swamp Allegiance 1",
				AllegianceKey = "binalRatAllegianceSwamp",
				Location = new ValueNode
				{
					Location = new Vector2(2388f, 5000f)
				}
			},
			AllegianceData = new AllegianceData
			{
				ForageAndHuntingRadius = 1000,
				Name = "Binal Rat Swamp Allegiance",
				KeyName = "binalRatAllegianceSwamp",
				EntityType = "entity:binalRat",
				AllegianceType = AllegianceType.Other,
				StatsData = new StatsData
		...
		list.Add(new SpawnAllegianceAction
		{
			KeyName = "spawnBinalRatExpeditionSwamp2",
			Site = "playSite",
			ExpeditionData = new ExpeditionData
			{
				KeyName = "binalRatAllegianceSwamp2",
				Name = "Binal Rat Swamp Allegiance 2",
				AllegianceKey = "binalRatAllegianceSwamp2",
				Location = new ValueNode
				{
					Location = new Vector2(800f, 5000f)
				}
			},
			AllegianceData = new AllegianceData
			{
		...
		list.Add(new SpawnAllegianceAction
		{
			...
			ExpeditionData = new ExpeditionData
			{
				...
				Location = new ValueNode
				{
					Location = new Vector2(770f, 2800f)
				}
			},
			AllegianceData = new AllegianceData
			{
		...
		list.Add(new SpawnAllegianceAction
		{
			KeyName = "spawnSwampDemonTreeExpedition#1",
			Site = "playSite",
			ExpeditionData = new ExpeditionData
			{
				KeyName = "swampDemonTreeAllegiance#1",
				Name = "Swamp Demon Tree Allegiance #1",
				AllegianceKey = "swampDemonTreeAllegiance#1",
				Location = new ValueNode
				{
					Location = new Vector2(768f, 5328f)
				}
			},
			AllegianceData = new AllegianceData
			{
		...
		list.Add(new SpawnAllegianceAction
		{
			...
			ExpeditionData = new ExpeditionData
			{
				...
				Location = new ValueNode
				{
					Location = new Vector2(2000f, 4800f)
				}
			},
			AllegianceData = new AllegianceData
			{
		...
		list.Add(new SpawnAllegianceAction
		{
			...
			ExpeditionData = new ExpeditionData
			{
				...
				Location = new ValueNode
				{
					Location = new Vector2(5328f, 912f)
				}
			},
			AllegianceData = new AllegianceData
			{
		...
		list.Add(new SpawnAllegianceAction
		{
			KeyName = "spawnSnatcherExpedition#2",
			Site = "playSite",
			ExpeditionData = new ExpeditionData
			{
				KeyName = "snatcherAllegiance#2",
				Name = "Whipjaw Allegiance",
				AllegianceKey = "snatcherAllegiance#2",
				Location = new ValueNode
				{
					Location = new Vector2(4992f, 624f)
				}
			},
			AllegianceData = new AllegianceData
			{
		...
		list.Add(new SpawnAllegianceAction
		{
			...
			ExpeditionData = new ExpeditionData
			{
				...
				Location = new ValueNode
				{
					Location = new Vector2(2736f, 1776f)
				}
			},
			AllegianceData = new AllegianceData
			{
		...
		list.Add(new SpawnAllegianceAction
		{
			KeyName = "spawnThunderChickenExpedition#3",
			Site = "playSite",
			ExpeditionData = new ExpeditionData
			{
				KeyName = "thunderChickenAllegiance#3",
				Name = "Thunder Chicken Allegiance",
				AllegianceKey = "thunderChickenAllegiance#3",
				Location = new ValueNode
				{
					Location = new Vector2(5328f, 5328f)
				}
			},
			AllegianceData = new AllegianceData
			{
		...
		list.Add(new SpawnAllegianceAction
		{
			KeyName = "spawnLeafcutterExpedition#2",
			Site = "playSite",
			ExpeditionData = new ExpeditionData
			{
				KeyName = "leafcutterAllegiance#2",
				Name = "Leafcutter Expedition",
				AllegianceKey = "leafcutterAllegiance#2",
				Location = new ValueNode
				{
					Location = new Vector2(2496f, 240f)
				}
			},
			AllegianceData = new AllegianceData
			{
		...
		list.Add(new SpawnAllegianceAction
		{
			KeyName = "spawnLeafcutterExpedition#4",
			Site = "playSite",
			ExpeditionData = new ExpeditionData
			{
				KeyName = "leafcutterAllegiance#4",
				Name = "Leafcutter Expedition",
				AllegianceKey = "leafcutterAllegiance#4",
				Location = new ValueNode
				{
					Location = new Vector2(2784f, 1632f)
				}
			},
			AllegianceData = new AllegianceData
			{
		...
		list.Add(new SpawnAllegianceAction
		{
			KeyName = "spawnLeafcutterExpedition#5",
			Site = "playSite",
			ExpeditionData = new ExpeditionData
			{
				KeyName = "leafcutterAllegiance#5",
				Name = "Leafcutter Expedition",
				AllegianceKey = "leafcutterAllegiance#5",
				Location = new ValueNode
				{
					Location = new Vector2(912f, 1248f)
				}
			},
			AllegianceData = new AllegianceData
			{
		...
		list.Add(new SetPropertyAction
		{
			KeyName = "setSpawnIntervalBushDragonsNormal",
		...
		list.Add(new SetPropertyAction
		{
			KeyName = "setSpawnIntervalTwinklersNormal",
		...
		list.Add(new SetPropertyAction
		{
			KeyName = "setMaxBushDragonsNormal",
		...
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:smallPlotSpot",
				Name = "Small plot (2119, 1882)",
				Location = new Vector3(4825f, 5136f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:smallPlotSpot",
				Name = "Small plot (2119, 1882)",
				Location = new Vector3(4666f, 5136f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
		...
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:largePlotSpot",
				Name = "Large plot (2119, 1882)",
				Location = new Vector3(4970f, 5626f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
		...
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:pierSpot",
				Name = "Pier spot",
				Location = new Vector3(4340f, 5192f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
		...
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				...
				Location = new Vector3(4057f, 2758f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				...
				Location = new Vector3(3504f, 3440f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:fishTrapSpotCreek",
				Name = "Fish weir spot (3504f, 3456f)",
				Location = new Vector3(2496f, 3982f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:fishTrapSpotCreek",
				Name = "Fish weir spot (3504f, 3456f)",
				Location = new Vector3(1900f, 4330f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
		...
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:fishTrapSpotCreek",
				Name = "Fish weir spot (3504f, 3456f)",
				Location = new Vector3(4930f, 250f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				...
				Location = new Vector3(4254f, 233f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:fishTrapSpotCoast",
				Name = "Fish trap spot Saltwater",
				Location = new Vector3(5303f, 252f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:fishTrapSpotCoast",
				Name = "Fish trap spot Saltwater",
				Location = new Vector3(4465f, 5800f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:fishTrapSpotCoast",
				Name = "Fish trap spot Saltwater",
				Location = new Vector3(4575f, 5474f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
		...
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:fishTrapSpotShore",
				Name = "Fish trap spot Freshwater",
				Location = new Vector3(3576f, 3128f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:fishTrapSpotShore",
				Name = "Fish trap spot Freshwater",
				Location = new Vector3(4000f, 2520f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:fishTrapSpotShore",
				Name = "Fish trap spot Freshwater",
				Location = new Vector3(4972f, 2150f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:fishTrapSpotShore",
				Name = "Fish trap spot Freshwater",
				Location = new Vector3(4618f, 2900f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:fishTrapSpotShore",
				Name = "Fish trap spot Freshwater",
				Location = new Vector3(2827f, 3784f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:fishTrapSpotShore",
				Name = "Fish trap spot Freshwater",
				Location = new Vector3(3178f, 4210f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:fishTrapSpotShore",
				Name = "Fish trap spot Freshwater",
				Location = new Vector3(2342f, 4362f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
			KeyName = "startFishTrapShore16",
			DelayInSeconds = 1.0,
			EntityData = new EntityData
			{
				EntityKey = "terrain:fishTrapSpotShore",
				Name = "Fish trap spot Freshwater",
				Location = new Vector3(760f, 4280f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
		...
		list.Add(new SpawnEntityAction
		{
			KeyName = "startFishTrapShore20",
			DelayInSeconds = 1.0,
			EntityData = new EntityData
			{
				EntityKey = "terrain:fishTrapSpotShore",
				Name = "Fish trap spot Freshwater",
				Location = new Vector3(4128f, 5148f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
		...
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:bogOreDeposit",
				Name = "Bog ore deposit",
				Location = new Vector3(5616f, 5492f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
		...
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:peatDeposit",
				Name = "Peat deposit",
				Location = new Vector3(5361f, 5636f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
		...
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:saltDeposit",
				Name = "Salt deposit",
				Location = new Vector3(4992f, 3648f, 0f)
			}
		});
		list.Add(new SpawnEntityAction
		{
		...
		list.Add(new SpawnEntityAction
		{
			...
			EntityData = new EntityData
			{
				EntityKey = "terrain:clayDeposit",
				Name = "Clay deposit",
				Location = new Vector3(3600f, 4800f, 0f)
			}
		});
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = MapManager.TileToWorldPosVector2(new Point(15, 101))
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = MapManager.TileToWorldPosVector2(new Point(9, 110))
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = MapManager.TileToWorldPosVector2(new Point(22, 112))
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = MapManager.TileToWorldPosVector2(new Point(38, 119))
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = MapManager.TileToWorldPosVector2(new Point(47, 107))
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = MapManager.TileToWorldPosVector2(new Point(34, 93))
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = new Vector2(5616f, 1248f)
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = new Vector2(5376f, 1258f)
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = new Vector2(5136f, 1488f)
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = new Vector2(5472f, 1248f)
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = new Vector2(5664f, 2496f)
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = new Vector2(4608f, 3505f)
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = new Vector2(5472f, 3648f)
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
		...
		list.Add(new ParticleEffectAction
		{
			...
			Location = new ValueNode
			{
				Location = new Vector2(3936f, 3840f)
			},
			ParticleEmitters = new ParticleEmitterEffect[1]
			{
				new ParticleEmitterEffect
